...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::post('/complaints/{id}/ahp', [\App\Http\Controllers\Admin\ComplaintController::class, 'storeAhpResult'])->name('complaints.ahp.store');
    Route::get('/ahp', [\App\Http\Controllers\Admin\AhpController::class, 'index'])->name('ahp.index');
    Route::post('/ahp/calculate', [\App\Http\Controllers\Admin\AhpController::class, 'calculate'])->name('ahp.calculate');
